...
const AccountBox=()=>{
  return(
    <div style={{height:100,borderRadius:10,padding:10,backgroundColor:'lightgrey',boxShadow:'1px 1px 2px 1px #00000030',margin:10}}>
...
const OrgAccountss=()=>{
  return (
    <div className='login' style={{position:'relative',minHeight:'100vh',height:'auto',display:'flex',justifyContent:'center',alignItems:'center'}}>
        <div style={{position:'absolute',top:30}}>
          <Avatar style={{backgroundColor:'white'}} icon={<CloseOutlined style={{color:'grey'}}/>}/>
        </div>
        <div style={{width:'min(400px,95vw)',height:'60vh',overflowY:'scroll',}}>
          
          <div style={{width:'100%',display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(120px,1fr))',justifyContent:'flex-start'}}>
          <AccountBox/>
          <AccountBox/>
          <AccountBox/>
          <AccountBox/>
