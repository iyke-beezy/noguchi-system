...
const ForumCard=({onClick,...props})=>{
    ...
    return(
        ...
        <div onClick={onClick} style={{width:'90%',cursor:'pointer',margin:12,height:'auto',borderWidth:'2px',borderStyle:'solid',borderColor:'whitesmoke',borderRadius:5,padding:15}}>
